...
/**
 * g_unsetenv - This is to remove environment variable
 * @info: This is a structure containing potential arguments. Used to maintain
 *        constant function prototype.
 *  Return: 1 on delete, 0 otherwise
 * @var: This i]s the string env var property
 */
int g_unsetenv(info_t *info, char *var)
{
 ...
 *  Return: Always 0
 */
int g_setenv(info_t *info, char *var, char *value)
{
	char *buf = NULL;
	list_t *node;
	char *p;

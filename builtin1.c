...
/**
 * g_myhistory - This displays the history list, one command by line, preceded
 *              with line numbers, starting at 0.
 * @info: This is a Structure containing potential arguments. Used to maintain
 *        constant function prototype.
 *  Return: Always 0
 */
int g_myhistory(info_t *info)
{
...
/**
 * g_myalias - This mimics the alias builtin (man alias)
 * @info: This is a Structure containing potential arguments. Used to maintain
 *          constant function prototype.
 *  Return: Always 0
 */
int g_myalias(info_t *info)
{
	int i = 0;
	char *p = NULL;
	list_t *node = NULL;
